      ...
      <q-list no-border link inset-delimiter>
        ...
        >
          <q-list no-bordered>
            ...
            <q-item clickable v-ripple to="/conditions">
              <q-item-section>Conditions Générales</q-item-section>
            </q-item>
            <q-item clickable v-ripple to="/confidentiality">
        ...
        >
          <q-list no-bordered>
            <q-item clickable v-ripple to="/i18n/index" target="_blank">
              <q-item-section>Éditeur I18N</q-item-section>
            </q-item>
            <q-item clickable v-ripple to="/admin/index" target="_blank">
              <q-item-section>Administration</q-item-section>
            </q-item>
            <q-item clickable v-ripple to="/help" target="_blank">
              <q-item-section>Manuel</q-item-section>
            </q-item>
          </q-list>
        </q-expansion-item>
      </q-list>
      ...
      <div>
        ...
        <q-dialog v-model="helpRequested">
          <q-card>
            ...
            <q-card-section>
              <HelpContentPage
                :helpTopic="settingsStore.helpTitle"
              ></HelpContentPage>
            </q-card-section>
          </q-card>
        </q-dialog>
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      //   // if (settingsStore.activeTour) {
      //   //   settingsStore.activeTour.start()
      //   // }
      // },
      getHelpTitle() {
