    ...
    <q-header elevated visible="false">
      <q-toolbar>
        ...
        <!-- <q-btn
          ...
          :aria-label="settingsStore.mini ? 'Affiche l\'icône et le texte des items du menu sur la gauche' : 'Affiche l\'icône seulement des items du menu sur la gauche'"
        >
          <q-icon
            :name="settingsStore.mini ? 'chevron_right': 'chevron_left'"
          >
          </q-icon>
        </q-btn> -->
      ...
      <div>
        <q-dialog v-model="helpRequested">
          <q-card style="width: 700px; max-width: 80vw">
            <q-toolbar>
              <q-toolbar-title
                >{{ $t('help.title') }} pour l'Aide</q-toolbar-title
              >
            ...
            <q-card-section>
              <HelpHelpPage></HelpHelpPage>
            </q-card-section>
          </q-card>
        </q-dialog>
      </div>
      <q-page padding>
        <HelpContentPage :helpTopic="showHelpTopic"></HelpContentPage>
      </q-page>
    </q-page-container>
  </q-layout>
</template>
...
// import HelpIndexPage from 'pages/help/HelpIndexPage.vue';
...
// import HelpReminderPage from 'pages/help/HelpReminderPage.vue'
import HelpHelpPage from 'pages/help/HelpHelpPage.vue';
import HelpContentPage from 'pages/help/HelpContentPage.vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    const $q = useQuasar();
    const showHelpTopic = ref('home.title');
    ...
    return {
      helpRequested,
      showHelpTopic,
      // showHelpTopic: ref(showHelpTopic),
      userStore,
      settingsStore,
      VERSION: VERSION,
      levelOptions,
      ...
      showHelp(topic: string) {
        console.log(topic);
        showHelpTopic.value = topic;
        // settingsStore.helpTitle = topic
      },
      getHelpBody() {
        // if (settingsStore.helpBody === '' ) {
        //   return t('home.body');
